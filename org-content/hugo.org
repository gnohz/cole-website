...
** TODO Competitive Programming vs App Making

** TODO How To Describe The Difference Between Functional and Imperative Programming Language

Potentially two aproaches:
- describe the high level differences
- describe functional programming as ocaml and imperative as python

** TODO The Power of Timers

** TODO Min Maxing Life

** DONE The Perception of Your Current vs Future Self            :@Thoughts:
CLOSED: [2021-04-30 Fri 22:29]
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: perceptions
:EXPORT_FILE_NAME: index
:END:
:LOGBOOK:
CLOCK: [2021-03-31 Wed 23:19]--[2021-04-01 Thu 00:15] =>  0:56
:END:
...
Similar to other post: discomfort should not be a part of the decision making process. Instead it is that your perception should not be a part of the decision making process. But so then what should be a part of the decision making process? Utilitarianism?

Why not push the timeline out to infinity? When do you stop?

Eventually your future self will become your present self, so why should we care about it?

The point is not that you shouldn't care about people's percpetion of you. The point is that it isn't worth trying to give a false impression. Instead let actions over time speak for themselves.

Sometimes giving a false impression is helpful.

It's not that you don't want to care about people

For soem point in the future it does become important to consider your present self at that time. This piece makes strong claims, but they are more so to make the point that people weigh the perception of their persent selves too highly. Yes, you have to consider your present self in decision making to a certain extent, but far less so than it typically the case.

Eventually it does become improtant to consider your "

Gives a ton of freedom. Releases you from perfectionism. 

How I apply it:
- when uploading blog posts and youtube videos, I don't obsess about if people with think of me as a bad writer or singer. I know that I either am good or bad at writing, and then over time my actions will speak for themselves.

Your perception matters, but don't let it get to your head.

The perception of your present self should not be a part of the decision making process. Instead, consider how your actions might lead to 

Do not focus on what other people think of your present self. Instead, think about what they will think of your future self.

Counterarguments:
- What about when the ends justify the means
  The most obvious example is an interview. You want to make yourself look better than you are so that you get the job.
- What if the lies are good to help push yourself harder
  You can take this line of reasoning.
- Why not push the timeline out to infinity? When do you stop?
  The rule is said more strictly than it has to be in order to make a point. Eventually 

Frame it as a mindset shift.
...
** TODO My Morning Routine

** TODO Getting Rid Of My Bedframe
** TODO Binary Search As A Tool For Getting Out Of Your Comfort Zone :@Thoughts:lifestyle:
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: binary-search
:EXPORT_FILE_NAME: index
:END:
:LOGBOOK:
CLOCK: [2021-03-12 Fri 10:38]--[2021-03-12 Fri 11:30] =>  0:52
:END:

*** Binary Search Overview

Binary search is an algorithm for finding an element in a list very fast.
...
Thinking of actions in terms of binary search helps rationalize "risky" actions, thus helping you out of your comfort zone.

There is the idea of "how bad can it be". Things that feel way out of your comfort zone are very likely not to really be that bad, but why risk it you tell yourself. 

You risk it to help you find the upper bound for binary search!

Don't take this too far.

There are many different directions of comfort zone.

*** Applying Binary Search To Your Comfort Zone
...
Why do comfort zones exist? What makes things outside of the comfort zone scary? It is based on people's aversion to risk. You've never done the action before, so it is hard to properly assess its risk. People tend to view it as more risky than it actually is, and hence don't give it a try. It is the unknown risk to reward.

Comfort zone is tied to levels of anxiety associated with actions. Where does anxiety come from? Risk-reward?

[[file:./comfort_zone.jpg]]

It is possible to expand your comfort zone because as you try more actions and understand their risks better, you can increase your confidence in the positive risk to reward.
...
I claim that you want to be taking actions in the growth zone which will expand your comfort zone. Without every leaving your comfort zone, we might never know what we are capable of and what we can do. But how do you do this?

One option is to make incremental progress. A linear search to to say. You find an action that would help you dip one toe out of your comfort zone, and see how it goes. 99% of the time you will see that it wasn't as scary as it looked, everything worked out fine, and you were happy you went for it. Congratulations, you just expanded your comfort zone by one big toe!

This works fine, but similarly to the linear search algorithm, it is very slow. You are expanding your comfort zone very interatively with the goal of never taking an action that might be more than a big toe riskier than what you are comfortable with.

Also it is even worse than linear search, because often times you will not be able to guage your comfort zone so you will be repeating actions with the same levels of comfort, and sometimes your comfort zone will shrink because you will forget that you expanded it.

**** Binary Search

This is where binary search comes in.

Why do a slow linear scan when you can go fast in $O(log_2(n))$! We have a monotonic function that takes the risk of an action as input and ouputs whether or not it is worth it. This assumes reward is constant?

Think of one dimensional examples:
- 

Out goal is to identify actions that offer the optimal level of risk (the point where you can't grow your comfort zone anymore because the risk begins to outweight the reward). Take actions with too low of a risk, and you are missing out on actions with higher risk. Take actions with too high of a risk, and you will face the consequences.


[[file:https://addicted2success.com/life/here-is-everything-you-need-to-know-about-your-comfort-zone/]]
...
https://positivepsychology.com/wp-content/uploads/2020/11/blog_graphic-768x384.png
...
*** How I Applied This To My Own Life
...
** TODO Don't fail the same way twice in a row
This is basically binary search.

** TODO On Sharing Food

** TODO Best Way To Do Things Is To Not Do The Wrong Things

** TODO Staring At Walls
...
** TODO Priorities for last minute change of plans
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: priorities-for-last-minute-change-of-plans
:EXPORT_FILE_NAME: index
:END:

** TODO Food

** TODO Safe Eyes Environment Over Engineering
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: environment-over-engineering
:EXPORT_FILE_NAME: index
:END:
** TODO Selfish Pleasure vs Selfish Success
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: selfish
:EXPORT_FILE_NAME: index
:END:
** TODO Sponges Have Incredible Cost to Return Ratio
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: sponge
:EXPORT_FILE_NAME: index
:END:
** TODO Fun vs Enjoyment
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: fun-vs-enjoyment
:EXPORT_FILE_NAME: index
:END:
** TODO Expectations affect on life
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: expectations
:EXPORT_FILE_NAME: index
:END:
...
** TODO Take bets and risks
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: take-bets
:EXPORT_FILE_NAME: index
:END:
** TODO To drink or not to drink
:LOGBOOK:
CLOCK: [2021-03-22 Mon 22:56]--[2021-03-22 Mon 23:56] =>  1:00
:END:


Only be around people where you don't have to drink to be around them.

Doesn't have to be a hard set rule.

Veganism doesn't have to be a hard set rule either.

https://www.quora.com/Why-dont-some-people-like-to-drink-alcohol-What-is-it-about-the-effects-of-alcohol-that-they-don%E2%80%99t-like
https://medium.com/the-ascent/8-reasons-why-i-dont-drink-alcohol-anymore-83cb85adcd5c

I got known for being the guy who "drinks vodka from the tap" (because I am drinking tap water).
...
Other reasons not to drink alcohol that weren't espeically important in my decision process:
...
It's easier to cut it out completely. How do you decide when to drink?

Remember things better.

There are down sides. Aspects about drinking I feel like I am missing out on:
...
In my day to day life I have 0 regrets about not drinking. I do wonder sometimes if my future self will regret not "taking better advantage of my youth". But my brother doesn't think I will.

*** I want to live a life that I enjoy soberly

I never want to find myself in a situation that I am enjoying solely because of alcohol. I don't feel like there is enough time in the day, so why prioritize making an undesired situation bearable when I could be doing something else like sleeping.

This raises the point: what about using 
*** Real Relationships

I don't want fake relationships and activities held together by alcohol.
*** The Appeals of Alcohol

In order to understand why I don't drink alcohol, its helpful to begin with the appeals of alcohol.
...
I don't drink because I feel like the day is too short. 

I don't drink because I would rather be doing something else. Potentially:
- sleeping
- exercising
- sober conversation with friends
- 

*** Thoughts

This can be a dangerous argument. Other things it can extend to:
- sex
- games

Basically anything that you do with others that has no productive value.

** TODO Choosing What To Eat
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: choosing-what-to-eat
:EXPORT_FILE_NAME: index
:END:
:LOGBOOK:
CLOCK: [2021-03-22 Mon 14:04]--[2021-03-22 Mon 14:44] =>  0:40
:END:

Let's talk about food.

There is so much food out there to eat, but basically they can all by quantified on the following dimensions:
- taste / novelty / provenance
- nutrition / volume
- time
- cost
...
** TODO What does covid do to interaction?
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: communication
:EXPORT_FILE_NAME: index
:END:

idea that highest form of interaction is discussion which isn't affected too much by video call
** TODO Types of Vegans
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: types-of-vegans
:EXPORT_FILE_NAME: index
:END:

- types of vegans:
  - care a lot about animals
  - don't care much about animals but still think it is the right thing to do
** TODO Transitive Property of Relationships
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: transitive-property-of-relationships
:EXPORT_FILE_NAME: index
:END:

similar couples could interchange their partners pretty easily
** TODO Reflect on cheating
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: cheating
:EXPORT_FILE_NAME: index
:END:
** TODO Learning From Failure vs Learning
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: learning-from-failure-vs-learning
:EXPORT_FILE_NAME: index
:END:

** TODO Jealousy
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: jealousy
:EXPORT_FILE_NAME: index
:END:

Jealousy is unfortunate. It gets between you and feeling joy for someone else's success.
** TODO Blogging means writing your thoughts down
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: blogging-means-writing-your-thoughts-down
:EXPORT_FILE_NAME: index
:END:
...
** TODO Valid Reasons for Seeing Friends
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: valid-reasons-for-seeing-friends
:EXPORT_FILE_NAME: index
:END:


Is laughing / gaming valid reason to hang out with friends? What makes those activities better with them than with strangers?
* Book Notes
:PROPERTIES:
