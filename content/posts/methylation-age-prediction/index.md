...
<details style="margin-bottom: 2.5em">
    <summary>Code To Download Dataset</summary>
    {{< highlight python >}}
...
<details>
    ...
    <p>
    The first line splits the code into random train and test sets. <br><br>
    Then we declare a coll_array and populate it with the correlations of each of the features with respect to age. <br><br>
